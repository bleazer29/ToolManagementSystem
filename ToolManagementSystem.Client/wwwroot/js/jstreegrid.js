        ...
        for (var i = 0, len = s.columns.length;i<len;i++) {
            ...
            gs.gridcols.push(i);
				...
				if (!styled) {
					styled = true;
					styles = [
						'.jstree-grid-cell {vertical-align: top; border: 1px solid #dee2e6; overflow:hidden;margin-left:0;position:relative;width: 100%;white-space: nowrap;-ms-scroll-limit: 0 0 0 0;}',
						'.jstree-grid-cell span {margin-right:0px;margin-right:0px;*display:inline;*+display:inline;white-space: nowrap; margin-bottom:.25rem;}',
						'.jstree-grid-separator {position:absolute; top:0; right:0; margin-left: -2px; border-width: 0 2px 0 0; *display:inline; *+display:inline; margin-right:0px;width:0px;}',
						'.jstree-grid-header-cell {overflow: hidden; white-space: nowrap;padding: 12px; cursor: default;}',
						'.jstree-grid-header-themeroller {border: 0; padding: 3px 6px;}',
						'.jstree-grid-header-regular {position:relative; background-color: gray; color: white; border: 1px solid #dee2e6; z-index: 1;}',
						...
						'.jstree-grid-midwrapper {width: 100%;  border: 1px solid #dee2e6;}',
      ...
      return (ret);
        ...
        for (var i = 0, len = cols.length;i<len;i++) {
          ...
          gridCellParent = findDataCell(uniq, gridCellParentId, i, column);
			...
			last = last.css(conf).addClass("jstree-grid-cell text-center jstree-grid-cell-regular jstree-grid-cell-root-" + rootid + " jstree-grid-cell-" + classAdd + " " + wcl + " " + wideValClass + (tr ? " ui-state-default" : "")).addClass("jstree-grid-col-" + i).addClass("jstree-animated");
